...
# special case hairpins with precalculated energies
    ...
    def closingPair(self, newClose=None):
        if newClose:
            try:
                ...
                print(
                    'Please provide and tuple with the opening and closing base pairs for the hairpin.')
        else:
