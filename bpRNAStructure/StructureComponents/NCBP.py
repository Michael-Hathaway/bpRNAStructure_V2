...
self._basePair -- tuple(string, string) -- tuple containing the base pairs
    that define the NCBP object
self._basePairSpan -- tuple(int, int) -- tuple containing the integer
    locations of the NCBP
self._parentUnit -- string -- label for the secondary structure that the
    NCBP is located in
'''
...
class NCBP:
    ...
    '''
    Function: NCBP.pair()
    Description: Function returns a tuple containing the two base pairs that
                define the NCBP object
    Parameters:
    ...
    '''
    Function: NCBP.span()
    Description: Function returns a tuple containing the integer locations of
                the base pairs that define the NCBP
    Parameters: None
    Return Value:
    ...
    Description: Function returns a string the identifies the secondary
                structure that the NCBP occurs in
    Parameters: None
    Return Value:
