...
self._sequences -- dictionary -- dictionary of the multiloop component
    sequences. key values are the subunit labels
self._span -- dictionary -- dictionary of the multiloop component spans. key
    values are the subunit labels
self._closingPairs -- ((str, str), (str, str)) -- tuple containing the 5' and
    3' closing base pairs as tuples
self._closingPairsSpan - ((int, int), (int, int)) -- tuple containing the 5'
    and 3' closing base pair spans as tuples
'''
...
class Multiloop:
    ...
    Parameters:
            (newLabel=None) -- str -- new label to identify the Multiloop
            object
    Return Value:
    ...
    Description: Function to return a list of the MultiLoop object
                subcomponents
    Parameters: None
    Return Value:
    ...
    Description: Function to return the number of subcomponents composing
                the MultiLoop
    Parameters: None
    Return Value:
    ...
    Description: Function to return dictionary of subunitLabel : Sequence pairs
                for the MultiLoop object
    Parameters:
            (subunit=None) -- str -- label for the specific subunit being
            accessed.
    Return Value:
            dict - dictionary of multiloop sequences mapped to their subunit
            label
            * if a specific subunit label is provided, only that sequence will
            be returned
    '''
    ...
    Description: Function to return dictionary of subunitLabel : SequenceSpans
        pairs for the MultiLoop object
    Parameters:
            (subunit=None) -- str -- label for specific subunit being accessed
    Return Value:
            dict - dictionary of tuples defining start and stop indicies for
            multiloop subunits mapped to their subunit label
            * if a specific subunit label is provided, only that tuple will
            be returned
    '''
    ...
    Description: Function to return dictionary of subunitLabel : closingPairs
                for the MultiLoop object
    Parameters:
            (subunit=None) -- str -- label for specific subunit being accessed
    Return Value:
            dict - dictionary of tuples defining closing base pairs for
            multiloop subunits mapped to their subunit label
            * if a specific subunit label is provided, only that tuple
            will be returned
    '''
    ...
    Description: Function to return dictionary of subunitLabel :
                closingPairsSpan for the MultiLoop object
    Parameters:
            (subunit=None) -- str -- label for specific subunit being accessed
    Return Value:
            dict - dictionary of tuples defining closing base pair index
            locations for multiloop subunits mapped to their subunit label
            * if a specific subunit label is provided, only that tuple
            will be returned
    '''
